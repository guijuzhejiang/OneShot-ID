...
if __name__ == "__main__":
    ...
    # Load face encoder
    app = FaceAnalysis(name='/media/zzg/GJ_disk01/pretrained_model/stable-diffusion-webui/models/insightface/models/antelopev2', root='./', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
    app.prepare(ctx_id=0, det_size=(640, 640))

    # Path to InstantID models
    face_adapter = f'/media/zzg/GJ_disk01/pretrained_model/InstantX/InstantID/ip-adapter.bin'
    controlnet_path = f'/media/zzg/GJ_disk01/pretrained_model/InstantX/InstantID/ControlNetModel'
    controlnet_depth_path = f'/media/zzg/GJ_disk01/pretrained_model/diffusers/controlnet-depth-sdxl-1.0-small'
    ...
    # base_model_path = '/media/zzg/GJ_disk01/pretrained_model/stabilityai/stable-diffusion-xl-base-1.0'
    base_model_path = '/media/zzg/GJ_disk01/pretrained_model/stable-diffusion-webui/models/Stable-diffusion/SDXL/juggernautXL_ragnarokBy.safetensors'
    ...
    face_image = load_image("/home/zzg/workspace/pycharm/OneShot-ID/input/Test_image.png")
